...
namespace ShooterConsts {
    ...
    const std::string DRAGON_OBJ = "obj/items/dragon_head.obj";
    const std::string DRAGON_FIRE_SOUND = "sound/weapons/dragon_fire.ogg";
    const std::string DRAGON_RELOAD_SOUND = "sound/weapons/dragon_reload.ogg";
